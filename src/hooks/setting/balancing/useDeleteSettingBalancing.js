...
export function useDeleteSettingBalancing(): [DeleteSetting, 'idle' | 'loading' | 'success' | 'error'] {
    ...
    const {mutate, status} = useMutation({
        ...
        onSuccess: (data) => {
            if (data.message || data.error) {
                ...
                message.success("Правило маршрутизации и балансировки было удалено успешно");
            }
        }
    })
